        ...
        <ul class="navbar-nav bg-gradient-light sidebar sidebar-danger accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="#">
                <div class="sidebar-brand-icon rotate-n-0">
                    <img src="{{asset('asset/img/logo.png')}}" width="80">
                </div>
                <div class="sidebar-brand-icon rotate-n-0">
                    <img src="{{asset('asset/img/logo1.png')}}" width="150">
                </div>
            </a>
            ...
            <li class="nav-item">
                @role('staf')
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePages"ari-expanded="true" aria-controls="collapsePages">
                    <i class="fas fa-fw fa-folder-open"></i>
                    <span>Data Master</span>
                </a>
                <div id="collapsePages" class="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
                    <div class="bg-light py-2 collapse-inner rounded">
                        <a class="collapse-item fas fa-arrow-circle-right" href="{{ route('user.index') }}"> Master Pengguna</a>
            ...
            <hr class="sidebar-divider">
            <li class="nav-item">
                <a class="nav-link" href="{{ route('pilihsepatu.transaksisepatu') }}">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Sepatu</span></a>
            </li>
            <hr class="sidebar-divider">
            <li class="nav-item">
                <a class="nav-link" href="{{ route('pilihmuslim.transaksimuslim') }}">
                    <i class="fas fa-fw fa-table"></i>
                    <span>Fashion Muslim</span></a>
            </li>
            <hr class="sidebar-divider">
            <li class="nav-item">
                <a class="nav-link" href="{{ route('pilihcraft.transaksicraft') }}">
                    <i class="fas fa-fw fa-table"></i>
            ...
            <li class="nav-item">
                @role('staf')
                <a class="nav-link" href="{{ route('keranjang.transaksi') }}">
                    <i class="fas fa-fw fa-archive"></i>
                    <span>Klaim Penjualan</span></a>
                @endrole
            </li>
            <li class="nav-item">
                @role('staf')
                ...
                <div id="collapsePages3" class="collapse" aria-labelledby="headingPages"
                    ...
                    <div class="bg-light py-2 collapse-inner rounded">
                        <a class="collapse-item fas fa-arrow-circle-right" href="{{ route('pemesanan.transaksi') }}"> Pemesanan Stok</a>
                        <a class="collapse-item fas fa-arrow-circle-right" href="{{ route('pembelian.transaksi') }}"> Klaim Pembelian</a>
                        <a class="collapse-item fas fa-arrow-circle-right" href="{{ route('retur.transaksi') }}"> Pengembalian Barang</a>
                    </div>
                </div>
                @endrole
            </li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <img class="img-profile rounded-circle" src="{{asset('asset/img/avatargold.png')}}">
                            </a>
            ...
            <footer class="sticky-footer bg-green">
                ...
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Create By: Pick Me's Team<br>Copyright &copy; Pemrograman Akuntansi II 2022</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
