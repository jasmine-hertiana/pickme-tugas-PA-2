...
<style>
    ...
    body
    {
        background-image: url('asset/img/peach.jpg');
                            ...
                            <div class="col-lg-20">
                                <div class="p-5">
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4">Fashion & Handicraft<br>
                                            <br><img src="{{ asset('asset/img/pick_me.png')}}" width="160">
                                        </h1>
                                    </div>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6"> 
                                                <input id="kategori" type="text"
                                                    ...
                                                    value="customer" required autocomplete="kategori" autofocus>
                                                @error('kategori')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6"> 
                                                <input id="notelp" type="text"
                                                    ...
                                                    value="{{ old('notelp') }}" required autocomplete="kategori" autofocus>
                                                @error('notelp')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
