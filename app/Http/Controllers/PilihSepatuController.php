...
use App\Temp_pilih;
use Alert;
class PilihSepatuController extends Controller
{
    public function index()
    {
        ...
        $AWAL = 'TRX';
            ...
            return view('pilih.pilihsepatu' ,['barang' => $barang,'akun' => $akun,'temp_pilih'=>$temp_pilih,'formatnya'=>$formatnya]);
    }
    public function tambahOrder()
    {
        return view('pilihsepatu');
    }
    public function store(Request $request)
    {
        ...
        if (Pilih_tem::where('kd_brg', $request->brg)->exists()) 
        {
            ...
            return redirect('transaksisepatu');
        }else{
