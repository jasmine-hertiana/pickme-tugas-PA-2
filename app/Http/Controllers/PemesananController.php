...
class PemesananController extends Controller
{
    public function index()
    {
        ...
        $AWAL = 'TRX';
            ...
            return view('pemesanan.pemesanan' ,['barang' => $barang,'akun' => $akun,'supplier'=>$supplier,'temp_pemesanan'=>$temp_pesan,'formatnya'=>$formatnya]);
    }
    ...
    public function store(Request $request)
    {
        ...
        if (Pemesanan_tem::where('kd_brg', $request->brg)->exists()) 
        {
            ...
            Pemesanan_tem::create(['qty_pesan' => $request->qty,'kd_brg' => $request->brg]);
            return redirect('transaksi');
        }
    }
